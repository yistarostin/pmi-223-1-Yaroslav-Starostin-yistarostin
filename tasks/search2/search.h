...
class SearchEngine {
    ...
    bool has_index_;
    static long double GetLineTF(std::vector<std::string_view> line, std::string_view target_word);
    std::vector<size_t> GetInterestingLines(const InsensitiveHashSet& words_bag) const;
